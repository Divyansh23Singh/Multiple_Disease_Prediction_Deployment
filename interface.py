...
diab_model = pickle.load(open("Diabetes_svm.pkl","rb"));
heart_model = pickle.load(open("naive_heart.pkl","rb"));
park_model = pickle.load(open("svm_parks.pkl","rb"));
...
if selected=='Diabetes Prediction':
    ...
    if st.button("Diabetes Test Result"):
        ...
        predn = diab_model3.predict([user_input])
